...
//    }
    ...
    public static int[][][] cullFacesOnEquipmentPart(SkinPart skinPart) {
        ...
        for (int i = 0; i < cubeData.getCubeCount(); i++) {
            ...
            skinPart.getBakedPart().totalCubesInPart[cubeId] += 1;
...
//            }
    ...
    private static ArrayList<CubeLocation> checkCubesAroundLocation(SkinPart.Data cubeData, CubeLocation cubeLocation,
    ...
    private static void flagCubeFace(int x, int y, int z, int face, Rectangle3D partBounds, int[][][] cubeArray, SkinPart.Data cubeData, boolean isGlass) {
    ...
    public static void buildPartDisplayListArray(SkinPart partData, int[][] dyeColour, int[] dyeUseCount, int[][][] cubeArray) {
        ...
        renderLists = (ArrayList<BakedFace>[]) new ArrayList[Skin43D.instance().getContext().getNumberOfRenderLayers() * (lodLevels + 1)];
        ...
        partData.getBakedPart().setVertexLists(renderLists);
    }
    ...
    private static byte[] getAverageRGBAT(int x, int y, int z, byte lodLevel, int[][][] cubeArray, SkinPart.Data cubeData, Rectangle3D partBounds, int face) {
        int count = 0;
        int r = 0;
        int g = 0;
        int b = 0;
