...
public final class LegacyCubeHelper {
    ...
    public static void loadLegacyCubeData(SkinPart.Data cubeData, int index, DataInput input, int version, SkinPartType skinPart) throws IOException, InvalidCubeTypeException {
        if (version < 3) {
    ...
    public static void loadlegacyCube(SkinPart.Data cubeData, int index, DataInput stream, int version, SkinPartType skinPart) throws IOException, InvalidCubeTypeException {
        byte x;
        byte y;
        byte z;
        int colour;
